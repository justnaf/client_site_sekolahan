                ...
                <div class="card-body">
                    <div class="form-group">    
                        ...
                        <select class="form-control" name="user_id" id="user_id" required>
                            ...
                            <option value="{{$user->id}}" @if ($user->id == $guru->user_id)
                                selected="" 
                                @endif> {{ $user->id }}</option>
                            @endforeach
                        </select>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control" name="gender" id="gender" required>
                            <option value="laki-laki" @if ($guru->gender == 'laki-laki') selected=""
                                @endif>Laki-Laki</option>
                            <option value="perempuan" @if ($guru->gender == 'perempuan') selected=""
                    ...
                    <div class="form-group">
                        ...
                        <input id="phone_number" type="number"
                            ...
                            name="phone_number" value="{{ $guru->phone_number}}" id="phoneValidation"
                            value="{{ old('phone_number') }}" placeholder="Nomor Telphone" required autocomplete="nik"
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="pendidikan" id="pendidikan"
                            placeholder="pendidikan" value="{{ $guru->pendidikan }}" required>
                    </div>
                    <div class="form-group">
                        <label for="exampleInputPassword1">Alamat</label>
                        <textarea name="alamat" class="form-control" id="alamat" cols="30" rows="10"
                            placeholder="alamat" required>{{ $guru->alamat }}</textarea>
                    </div>
                    <div class="card-body">
