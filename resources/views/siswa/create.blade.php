    ...
    <div class="card">
        ...
        <div class="card-body">
            ...
            <div class="form-group">
                <label for="exampleInput JK">Kelas</label>
            ...
            <div class="form-group">
                <label for="exampleInputPendidikanTerakhir">Nomor Telphone</label>
                    <input id="phone_number" type="number" class="form-control form-control-user
                        @error('phone_number') is-invalid @enderror" name="phone_number" id="phoneValidation"
                        placeholder="nomor telphone" required autocomplete="phone number"
